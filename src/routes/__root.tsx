  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 font-display text-xl text-foreground">Página fora do lobby</h2>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-xl text-foreground">Essa página não carregou</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Tivemos um problema por aqui. Tente atualizar ou volte para o início.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BRZ.CUP — Campeonatos diários de Free Fire" },
      {
        name: "description",
        content:
          "BRZ.CUP: campeonatos diários de Free Fire com premiação por kill, rankings e perfis de jogador. Do lobby pra história.",
      },
      { property: "og:title", content: "BRZ.CUP — Do lobby pra história" },
      {
        property: "og:description",
        content: "Campeonatos diários de Free Fire, R$2 por kill e rankings semanais.",
      },
